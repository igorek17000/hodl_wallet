(function () {
  ...
  function executeCallback(id, error, value) {
    dappWallet.executeCallback(id, error, value);
  }

  window.dappWallet.init(
    __rpcURL,
    {
      ...
      signPersonalMessage: function (msgParams, cb) {
        ...
        const { id = 8888 } = msgParams;
        dappWallet.addCallback(id, cb);
        dapp.signPersonalMessage(id, data);
      },
      signTypedMessage: function (msgParams, cb) {
        ...
        const { id = 8888 } = msgParams;
        dappWallet.addCallback(id, cb);
        dapp.signTypedMessage(id, JSON.stringify(msgParams));
      },
      ethCall: function (msgParams, cb) {
        ...
        dappWallet.addCallback(id, cb);
        dapp.ethCall(id, JSON.stringify(msgParams));
        //dapp.ethCall(id, msgParams.to, msgParams.data, msgParams.value);
      },
      walletAddEthereumChain: function (msgParams, cb) {
        ...
        dappWallet.addCallback(id, cb);
        dapp.walletAddEthereumChain(id, JSON.stringify(msgParams));
      ...
      walletSwitchEthereumChain: function (msgParams, cb) {
        ...
        dappWallet.addCallback(id, cb);
        dapp.walletSwitchEthereumChain(id, JSON.stringify(msgParams));
  ...
  window.web3.setProvider = function () {
    console.debug("dapp Wallet - overrode web3.setProvider");
  };
